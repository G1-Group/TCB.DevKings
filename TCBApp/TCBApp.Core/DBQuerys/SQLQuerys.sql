...
user_name varchar(30),nickname varchar(20),status int,isPremium bool);
...
create table boards(board_id serial primary key,nickname varchar(15), owner_id bigint references clients(client_id),board_status int);
...
board_id bigint REFERENCES boards(board_id),message_type int,message_status int);
